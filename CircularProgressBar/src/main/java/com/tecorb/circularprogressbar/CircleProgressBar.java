package com.tecorb.circularprogressbar;
...
public class CircleProgressBar extends View {
    ...
    private void initPaints(Context context, AttributeSet attrs) {
       ...
       // progressValue =ta.getFloat(R.styleable.CircleProgressBar_progressV, 10);
    ...
    public void setProgressText(String preogressText){
        text = preogressText;
        invalidate();
    }
